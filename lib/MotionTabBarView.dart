...
class _TabStyle extends AnimatedWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle defaultStyle =
        (labelStyle ?? tabBarTheme.labelStyle ?? themeData.primaryTextTheme.body1)!.copyWith(inherit: true);
    final TextStyle defaultUnselectedStyle =
        (unselectedLabelStyle ?? tabBarTheme.unselectedLabelStyle ?? labelStyle ?? themeData.primaryTextTheme.body1)!
            .copyWith(inherit: true);
    final TextStyle textStyle = selected!
        ? TextStyle.lerp(defaultStyle, defaultUnselectedStyle, animation.value)!
        : TextStyle.lerp(defaultUnselectedStyle, defaultStyle, animation.value)!;

    final Color? selectedColor = labelColor ?? tabBarTheme.labelColor ?? themeData.primaryTextTheme.body1!.color;
...
class _IndicatorPainter extends CustomPainter {
  ...
  void saveTabOffsets(List<double>? tabOffsets, TextDirection? textDirection) {
    ...
    _currentTextDirection = textDirection ?? TextDirection.ltr;
  }
